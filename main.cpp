...
constexpr char	g_szConfig[]		= "mycfg.cfg";
constexpr char	g_szTargetTitle[]	= "Game Window Name";

int main()
{
	constexpr char	szDefaultName[]		= "shit.dll";
	constexpr char	szTargetClass[]		= "grcWindow";
	constexpr char	szWindowTitle[]		= "Title Of The Window";
	...
	printf_color("ShiTWarE. - All what you need! \n", TEXTCOL_BW);
	printf_color("%s Cheat \n", TEXTCOL_BW, g_szTargetTitle);
